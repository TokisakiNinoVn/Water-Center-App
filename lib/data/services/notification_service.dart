import 'package:clean_water/core/apis/customer/notification_api.dart';
...
class NotificationService {
  Future<ApiResponse> listNotification() async {
    return await ApiMethodsPrivate.request(
      HttpMethod.get,
      NotificationCustomerApi.list,
    );
  }

  Future<ApiResponse> readNotification(int id) async {
    return await ApiMethodsPrivate.request(
      HttpMethod.get,
      "${NotificationCustomerApi.read}/$id"
    );
  }
